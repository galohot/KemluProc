...
class CreateSpseJadwalTahapanTenderTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('spse_jadwal_tahapan_tender', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('spse_jadwal_tahapan_tender');
    }
}
