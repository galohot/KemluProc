...
class CreatePaketPenyediaLokasiTable extends Migration
{
    public function up()
    {
        Schema::create('paket_penyedia_lokasi', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('paket_penyedia_lokasi');
    }
};
