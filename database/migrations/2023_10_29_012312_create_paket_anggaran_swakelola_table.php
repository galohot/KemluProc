...
class CreatePaketAnggaranSwakelolaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('paket_anggaran_swakelola', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('paket_anggaran_swakelola');
    }
};
