...
class CreateEpurchasingUserPpksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('epurchasing_user_ppks', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('epurchasing_user_ppks');
    }
}
