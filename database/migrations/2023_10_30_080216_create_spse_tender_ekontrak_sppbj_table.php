...
class CreateSpseTenderEkontrakSppbjTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('spse_tender_ekontrak_sppbj', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('spse_tender_ekontrak_sppbj');
    }
}
